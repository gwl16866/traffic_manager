...
public class Statistics {
    ...
    * */
    ...
    public List<NData> inittableData2(){
        ...
        for (Saftyedu saftyedu : list) {
            okcount+=studentaccmqServiceImpI.thenumber(saftyedu.getStudent(),saftyedu.getId(),1);
        }
    ...
    public List<Saftyedu> xaingqing(){
        ...
        for (Saftyedu saftyedu : list) {
            int a=studentaccmqServiceImpI.thenumber(saftyedu.getStudent(),saftyedu.getId(),1);
            int b=studentaccmqServiceImpI.thenumber(saftyedu.getStudent(),saftyedu.getId(),2);
            if(a>0){
